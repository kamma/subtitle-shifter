...
public class ShifterApp {
	...
	protected void deleteSubtitleLine() {
		...
		if (index < 0)
			return;
		if (JOptionPane.showConfirmDialog(null, "Are you sure?", "Delete Subtitle",
	...
	private SubtitleLine createSubtitleDialog(String title, SubtitleLine sl) {
		...
		JScrollPane scrollPane = new JScrollPane(subText, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
				JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		scrollPane.setPreferredSize(new Dimension(380, 100));
		panel.add(scrollPane);
		int result = JOptionPane.showConfirmDialog(frmSubtitleshifter, panel, title, JOptionPane.OK_CANCEL_OPTION,
	...
	private class MyListCellRenderer extends DefaultListCellRenderer {
		...
		public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected,
			...
			String labelText = "<html><body><font color='blue'>" + sl.getLineNum() + "</font><br/><font color='red'>"
					+ sl.getTimeFromTo() + "</font><br/><font color='green'>" + sl.getTextAsHTML()
					+ "</font><br/></body></html>";
			setText(labelText);
			if (isSelected)
